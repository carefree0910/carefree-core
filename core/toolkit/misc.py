...
class ISerializable(
    ...
    def to_info(self) -> Dict[str, Any]:
        """this method should return a `dict` that can fully represent the object & can be JSON serialized"""

    @abstractmethod
    def from_info(self: T_s, info: Dict[str, Any]) -> T_s:  # type: ignore
        """this method should use the `dict` generated by `to_info` to restore the object to its original state"""
...
class ISerializableArrays(
    ...
    def to_npd(self) -> np_dict_type:
        """this method should return a `dict` of numpy arrays that can represent the adequate data of the object"""

    @abstractmethod
    def from_npd(self: T_sa, npd: np_dict_type) -> T_sa:  # type: ignore
        """this method should use the `dict` generated by `to_npd` to restore the object to its original state"""
...
class OPTBase(BaseModel, metaclass=ABCMeta):
    ...
    def env_key(self) -> str:
        """
        this property should return the key of the environment variable,
        so we can update this class via environment variables when needed.
        """
