...
class TestMisc(unittest.TestCase):
    ...
    def test_fix_float_to_length(self):
        ...
        self.assertEqual(fix_float_to_length(1.0e-13, 14), " 1.0000000e-13")
        self.assertEqual(fix_float_to_length(1.0e-12, 14), " 1.0000000e-12")
        self.assertEqual(fix_float_to_length(1.0e-11, 14), " 1.0000000e-11")
        self.assertEqual(fix_float_to_length(-1.0e-12, 14), "-1.0000000e-12")
        self.assertEqual(fix_float_to_length(-1.0e-11, 14), "-1.0000000e-11")
        self.assertEqual(fix_float_to_length(-1.0e-10, 14), "-1.0000000e-10")
